...
1. IBM watsonx Orchestrate with Builder role

External Technologies

1. Oracle HCM Instance
    1. An Oracle HCM user account with:
        1. Username/Password
        1. API access with ability to perform GET and PATCH calls to "workers" API, and GET calls to "publicWorkers" API
        3. The ability to create Oracle HCM Users
2. Custom code hosted on Flask to perform the patch function
...
5. Configure Action Steps and Extensions

#### Download and Import the prebuilt watsonx Orchestrate AI Assistant
1. Download the zip file for the Assistant
...
1. Download the Oracle HCM Custom Extension: Oracle - Get Managers and Employees
...
5. Download the "Apply Manager Update Patch" custom extension
...
#### Configure Action Steps and Extensions
