...
info:
  ...
  version: 1.0.0
servers:
  - url: https://iavnqy-dev1.fa.ocs.oraclecloud.com/
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/GetEmployeeWorkRelationshipsResponse'
        '400':
          description: Bad Request
        '401':
          description: Unauthorized - invalid credentials
...
components:
  schemas:
    ...
    GetEmployeeWorkRelationshipsResponse:
      type: object
      properties:
        items:
          type: array
          items:
            ...
            properties:
              PeriodOfServiceId:
                type: string
                description: The unique identifier for the period of service
  securitySchemes:
    basicAuth:
      type: http
      scheme: basic
