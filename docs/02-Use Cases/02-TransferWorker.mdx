...
Similarly to update a manager, it requires the above children URLs and goes one child further down the path in order to update an employee's manager anf accomplish the "Update Employee Manager" usecase.
