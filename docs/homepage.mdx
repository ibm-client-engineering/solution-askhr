...
[IBM AskHR Internal Assets](https://ibm.box.com/s/cqepux903hben88m7w89dwerq43wrnq9)

[IBM HR Assistant Product Page](https://www.ibm.com/products/watsonx-assistant/human-resources)
...
4. Process documentation for flight logging and usecase page creation from template
5. Create your own [pull request](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/about-pull-requests)
